...
namespace Grupo7_Market.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteId,NombreCliente")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,NombreCliente")] Clientes clientes)
        {
            if (ModelState.IsValid)
            {
